...
test("Deve encontrar recinto para leão", () => {
  ...
  // Tive que adicionar outro teste para garantir que pudesse também verificar com 2 leões

  const resultado2 = new RecintosZoo().analisaRecintos("LEAO", 2);
  expect(resultado2.recintosViaveis[0]).toBe(
